                ...
                <section className="grid grid-cols-1 p-4">
                    ...
                    <div className="flex flex-col justify-between items-start lg:flex-row lg:items-center p-4 gap-4">
                        <div className="flex gap-4 items-center">
                            ...
                            <div>
                                <button type="button" className="flex items-center text-nowrap gap-1 p-3.5 text-sm text-center text-white bg-[#736589] rounded-lg">Add New<IoMdAdd className="text-xl hidden md:block" /></button>
                            </div>
                        </div>
                        <div className="flex flex-col gap-2 md:gap-4 lg:gap-2 items-start lg:flex-row lg:justify-end lg:items-center">
                            <div className="flex gap-2">
                                <button type="button" className="text-green-700 text-nowrap hover:text-white border border-green-700 hover:bg-green-800 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-2 md:px-5 py-3 text-center">Active (53)</button>
                                <button type="button" className="text-[#813E0E] text-nowrap hover:text-white border border-[#813E0E] hover:bg-red-800 focus:outline-none font-medium rounded-lg text-sm px-2 md:px-5 py-3 text-center">Inactive (53)</button>
                                <button type="button" className="text-red-500 text-nowrap hover:text-white border border-red-500 hover:bg-red-500 focus:outline-none font-medium rounded-lg text-sm px-2 md:px-5 py-3 text-center">Trashed (53)</button>
                            </div>
                            <form class="w-full lg:w-1/3">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="search" id="default-search" class="block w-full p-3 ps-10 text-sm text-gray-900 rounded-xl bg-[#e9e9e9] outline-none" placeholder="Search..." required />
                                </div>
                            </form>
